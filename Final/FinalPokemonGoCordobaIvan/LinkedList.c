...
/** \brief Mapea los elementos y los modifica dependiendo de la funcion recibida
 *
 * \param *pFunc    Funcion recibida
 * \return LinkedList* ll_map (LinkedList* this     Retorna el nuevo linkedlist con los elementos modificados
 *
 */
...
/** \brief Cuenta los elementos que superaron el filtro de la funcion recibida
 *
 * \param *pFunc    Funcion recibida
 * \param this LinkedList*  Recibe el linkedlist
 * \return int  Retorna el total de la cantidad de elementos que superaron los filtros de la funcion recibida
 *
 */
...
/** \brief Busca el indice con el id recibido
 *
 * \param this LinkedList*  Recibe el linkedlist
 * \param id int        Id a buscar
 * \param index int*    Carga en el puntero el indice de la lista que tiene el id
 * \return int  int	Retorna (1)Si salio todo bien, (0)Si algo salio mal
 *
 */
